 ...
 */
public class Sm4Cipher implements UCipher {
    ...
    public byte[] encode(String key, byte[] content) throws Exception {
        ...
        try{
            ...
            ctx.isPadding = true;
            ctx.mode = Sm4Kit.SM4_ENCRYPT;
            byte[] keyBytes= key.getBytes("UTF-8");
            Sm4Kit sm4 = new Sm4Kit();
    ...
    public byte[] decode(String key, byte[] content) throws Exception {
        ...
        try
        {
            Context ctx = new Context();
            ctx.isPadding = true;
            ctx.mode = Sm4Kit.SM4_DECRYPT;
            byte[] keyBytes=key.getBytes("UTF-8");
            byte[] ciphers=content;
            Sm4Kit sm4 = new Sm4Kit();
    ...
    public static class Sm4Kit {
        ...
        public void sm4_setkey_enc(Context ctx, byte[] key) throws Exception
        {
            if (ctx == null)
            {
        ...
        public void sm4_setkey_dec(Context ctx, byte[] key) throws Exception
        {
            if (ctx == null)
            {
                throw new Exception("ctx is null!");
        ...
        public byte[] sm4_crypt_ecb(Context ctx, byte[] input) throws Exception
        {
            if (input == null)
            {
        ...
        public byte[] sm4_crypt_cbc(Context ctx, byte[] iv, byte[] input) throws Exception
        {
